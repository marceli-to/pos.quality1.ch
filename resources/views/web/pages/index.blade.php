  ...
  <div>
    ...
    <div class="landing-intro__list">
      ...
      <ul>
        ...
        <li>{{ __('Die Nummernschilder sowie Fahnen wurden entsprechend dem neuen Design erstellt und sind bereits erhältlich.') }}</li>
        <li>{{ __('Das Quality1-Logo kann bei AutoScout24 als Qualitätssiegel angezeigt werden.') }}</li>
      </ul>
    </div>
    <p>{!! __('Die optimale Wiedererkennung der Marke Quality1 bei Fahrzeughaltern ist unser Ziel. Davon profitiert auch Ihre Firma. Wir sind überzeugt, dass eine einheitliche Markenpräsenz zu einer klareren Positionierung führt.') !!}</p>
  </div>
</section>
