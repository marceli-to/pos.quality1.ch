  ...
  data() {
    return {
      ...
      de: {
        ...
        'placeholder_name': 'Name, Vorname',
        'placeholder_street': 'Strasse, Nr.',
        'placeholder_zip': 'PLZ',
        ...
        'plate_front': 'Nummernschild vorne (30 x 8 cm)',
        'plate_back': 'Nummernschild hinten (30 x 8 cm)',
        'flag': 'Quality1 Fahne (120 x 400 cm)',
        'pcs': 'Stk.',
        'choose': 'Menge wählen...',
        'deliver_to': 'Versand an:',
        'no_products_selected': 'Keine Produkte ausgewählt!',
        'product_required': 'Mind. 1 Produkt wird benötigt!',
        'company_required': 'Firma wird benötigt!',
        'street_required': 'Strasse wird benötigt!',
        'zip_required': 'PLZ wird benötigt!',
        'city_required': 'Ort wird benötigt!',
        ...
        'notification_order_success': 'Vielen Dank für Ihre Bestellung. Sie erhalten das bestellte Material in Kürze.',
        'characters': 'Zeichen',
      ...
      fr: {
        ...
        'btn_cancel': 'Annuler',
        'btn_order_now': 'Commander maintenant le nouveau matériel POS',
        'btn_more': 'Voir plus de photos',
        'btn_submit_order': 'Envoyer la commande',
        ...
        'placeholder_name': 'Nom, Prenom',
        'placeholder_street': 'Rue, no',
        'placeholder_zip': 'NPA',
        'placeholder_city': 'Localité',
        'placeholder_email': 'E-mail',
        ...
        'plate_front': 'Plaque d’immatriculation avant (30 × 8 cm)',
        'plate_back': 'Plaque d’immatriculation arrière (50 × 11 cm)',
        'flag': 'Drapeau Quality1 (120 × 400 cm)',
        'pcs': 'pcs.',
        'choose': 'Choisir la quantité...',
        'deliver_to': 'Envoi à',
        'no_products_selected': 'Keine Produkte ausgewählt!',
        'product_required': 'Mind. 1 Produkt wird benötigt!',
        'company_required': 'Entreprise requise!',
        'street_required': 'Rue requise!',
        'zip_required': 'NPA requise!',
        'city_required': 'Localité requise!',
        ...
        'notification_success': 'Merci de votre participation. Votre photo sera mise en ligne sous peu.',
        'notification_order_success': 'Merci de votre commande. Vous recevrez le matériel sous peu.',
      ...
      it: {
        ...
        'btn_cancel': 'Annulla',
        'btn_order_now': 'Ordinate ora il nuovo materiale POS',
        'btn_more': 'Mostra altre foto',
        'btn_submit_order': 'Invia l\'ordine',
        ...
        'placeholder_name': 'Nome, Cognome',
        'placeholder_street': 'Via, Nr.',
        'placeholder_zip': 'CAP',
        'placeholder_city': 'Località',
        'placeholder_email': 'E-mail',
        ...
        'plate_front': 'Targa d’immatricolazione anteriore (30 x 8 cm)',
        'plate_back': 'Targa d’immatricolazione posteriore (50 x 11 cm)',
        'flag': 'Bandiera a vento Quality1 (120 x 400 cm)',
        'pcs': 'pz.',
        'choose': 'Scegliere la quantità...',
        'deliver_to': 'Envoi à',
        'no_products_selected': 'Keine Produkte ausgewählt!',
        'product_required': 'Mind. 1 Produkt wird benötigt!',
        'company_required': 'È necessario indicare l’azienda!',
        'street_required': 'È necessario indicare la via!',
        'zip_required': 'È necessario indicare il CAP!',
        'city_required': 'È necessario indicare la località!',
        ...
        'notification_success': 'Grazie per aver partecipato. La foto verrà pubblicata a breve.',
        'notification_order_success': 'Grazie per l’ordinazione effettuata. Il materiale ordinato verrà spedito a breve.',
